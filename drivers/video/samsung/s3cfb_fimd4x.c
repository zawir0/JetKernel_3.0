...
#define SAVE_ITEM_TMP(x) \
       { .reg = (0) }

static struct sleep_save s3c_lcd_save[] = {
#if 1
       SAVE_ITEM_TMP(S3C_VIDCON0),
       SAVE_ITEM_TMP(S3C_VIDCON1),

       SAVE_ITEM_TMP(S3C_VIDTCON0),
       SAVE_ITEM_TMP(S3C_VIDTCON1),
       SAVE_ITEM_TMP(S3C_VIDTCON2),
       SAVE_ITEM_TMP(S3C_VIDTCON3),

       SAVE_ITEM_TMP(S3C_WINCON0),
       SAVE_ITEM_TMP(S3C_WINCON1),
       SAVE_ITEM_TMP(S3C_WINCON2),
       SAVE_ITEM_TMP(S3C_WINCON3),
       SAVE_ITEM_TMP(S3C_WINCON4),

       SAVE_ITEM_TMP(S3C_VIDOSD0A),
       SAVE_ITEM_TMP(S3C_VIDOSD0B),
       SAVE_ITEM_TMP(S3C_VIDOSD0C),

       SAVE_ITEM_TMP(S3C_VIDOSD1A),
       SAVE_ITEM_TMP(S3C_VIDOSD1B),
       SAVE_ITEM_TMP(S3C_VIDOSD1C),
       SAVE_ITEM_TMP(S3C_VIDOSD1D),

       SAVE_ITEM_TMP(S3C_VIDOSD2A),
       SAVE_ITEM_TMP(S3C_VIDOSD2B),
       SAVE_ITEM_TMP(S3C_VIDOSD2C),
       SAVE_ITEM_TMP(S3C_VIDOSD2D),

       SAVE_ITEM_TMP(S3C_VIDOSD3A),
       SAVE_ITEM_TMP(S3C_VIDOSD3B),
       SAVE_ITEM_TMP(S3C_VIDOSD3C),

       SAVE_ITEM_TMP(S3C_VIDOSD4A),
       SAVE_ITEM_TMP(S3C_VIDOSD4B),
       SAVE_ITEM_TMP(S3C_VIDOSD4C),

       SAVE_ITEM_TMP(S3C_VIDW00ADD0B0),
       SAVE_ITEM_TMP(S3C_VIDW00ADD0B1),
       SAVE_ITEM_TMP(S3C_VIDW01ADD0B0),
       SAVE_ITEM_TMP(S3C_VIDW01ADD0B1),
       SAVE_ITEM_TMP(S3C_VIDW02ADD0),
       SAVE_ITEM_TMP(S3C_VIDW03ADD0),
       SAVE_ITEM_TMP(S3C_VIDW04ADD0),
       SAVE_ITEM_TMP(S3C_VIDW00ADD1B0),
       SAVE_ITEM_TMP(S3C_VIDW00ADD1B1),
       SAVE_ITEM_TMP(S3C_VIDW01ADD1B0),
       SAVE_ITEM_TMP(S3C_VIDW01ADD1B1),
       SAVE_ITEM_TMP(S3C_VIDW02ADD1),
       SAVE_ITEM_TMP(S3C_VIDW03ADD1),
       SAVE_ITEM_TMP(S3C_VIDW04ADD1),
       SAVE_ITEM_TMP(S3C_VIDW00ADD2),
       SAVE_ITEM_TMP(S3C_VIDW01ADD2),
       SAVE_ITEM_TMP(S3C_VIDW02ADD2),
       SAVE_ITEM_TMP(S3C_VIDW03ADD2),
       SAVE_ITEM_TMP(S3C_VIDW04ADD2),

       SAVE_ITEM_TMP(S3C_VIDINTCON0),
       SAVE_ITEM_TMP(S3C_VIDINTCON1),
       SAVE_ITEM_TMP(S3C_W1KEYCON0),
       SAVE_ITEM_TMP(S3C_W1KEYCON1),
       SAVE_ITEM_TMP(S3C_W2KEYCON0),
       SAVE_ITEM_TMP(S3C_W2KEYCON1),

       SAVE_ITEM_TMP(S3C_W3KEYCON0),
       SAVE_ITEM_TMP(S3C_W3KEYCON1),
       SAVE_ITEM_TMP(S3C_W4KEYCON0),
       SAVE_ITEM_TMP(S3C_W4KEYCON1),
       SAVE_ITEM_TMP(S3C_DITHMODE),

       SAVE_ITEM_TMP(S3C_WIN0MAP),
       SAVE_ITEM_TMP(S3C_WIN1MAP),
       SAVE_ITEM_TMP(S3C_WIN2MAP),
       SAVE_ITEM_TMP(S3C_WIN3MAP),
       SAVE_ITEM_TMP(S3C_WIN4MAP),
       SAVE_ITEM_TMP(S3C_WPALCON),

       SAVE_ITEM_TMP(S3C_TRIGCON),
       SAVE_ITEM_TMP(S3C_I80IFCONA0),
       SAVE_ITEM_TMP(S3C_I80IFCONA1),
       SAVE_ITEM_TMP(S3C_I80IFCONB0),
       SAVE_ITEM_TMP(S3C_I80IFCONB1),
       SAVE_ITEM_TMP(S3C_LDI_CMDCON0),
       SAVE_ITEM_TMP(S3C_LDI_CMDCON1),
       SAVE_ITEM_TMP(S3C_SIFCCON0),
       SAVE_ITEM_TMP(S3C_SIFCCON1),
       SAVE_ITEM_TMP(S3C_SIFCCON2),

       SAVE_ITEM_TMP(S3C_LDI_CMD0),
       SAVE_ITEM_TMP(S3C_LDI_CMD1),
       SAVE_ITEM_TMP(S3C_LDI_CMD2),
       SAVE_ITEM_TMP(S3C_LDI_CMD3),
       SAVE_ITEM_TMP(S3C_LDI_CMD4),
       SAVE_ITEM_TMP(S3C_LDI_CMD5),
       SAVE_ITEM_TMP(S3C_LDI_CMD6),
       SAVE_ITEM_TMP(S3C_LDI_CMD7),
       SAVE_ITEM_TMP(S3C_LDI_CMD8),
       SAVE_ITEM_TMP(S3C_LDI_CMD9),
       SAVE_ITEM_TMP(S3C_LDI_CMD10),
       SAVE_ITEM_TMP(S3C_LDI_CMD11),

       SAVE_ITEM_TMP(S3C_W2PDATA01),
       SAVE_ITEM_TMP(S3C_W2PDATA23),
       SAVE_ITEM_TMP(S3C_W2PDATA45),
       SAVE_ITEM_TMP(S3C_W2PDATA67),
       SAVE_ITEM_TMP(S3C_W2PDATA89),
       SAVE_ITEM_TMP(S3C_W2PDATAAB),
       SAVE_ITEM_TMP(S3C_W2PDATACD),
       SAVE_ITEM_TMP(S3C_W2PDATAEF),
       SAVE_ITEM_TMP(S3C_W3PDATA01),
       SAVE_ITEM_TMP(S3C_W3PDATA23),
       SAVE_ITEM_TMP(S3C_W3PDATA45),
       SAVE_ITEM_TMP(S3C_W3PDATA67),
       SAVE_ITEM_TMP(S3C_W3PDATA89),
       SAVE_ITEM_TMP(S3C_W3PDATAAB),
       SAVE_ITEM_TMP(S3C_W3PDATACD),
       SAVE_ITEM_TMP(S3C_W3PDATAEF),
       SAVE_ITEM_TMP(S3C_W4PDATA01),
       SAVE_ITEM_TMP(S3C_W4PDATA23),

       //SAVE_ITEM_TMP(S3C_HOSTIFB_MIFPCON),
        /* for Idle Current GPIO Setting */
       SAVE_ITEM_TMP(S3C64XX_GPICON),
       SAVE_ITEM_TMP(S3C64XX_GPIDAT),
       SAVE_ITEM_TMP(S3C64XX_GPIPUD),
       SAVE_ITEM_TMP(S3C64XX_GPJCON),
       SAVE_ITEM_TMP(S3C64XX_GPJDAT),
       SAVE_ITEM_TMP(S3C64XX_GPJPUD),
 #endif
 };
...
#define SAVE_ITEM_DUM(x, y) \
        {x->reg = y; x++;}


void s3c_pm_tmp_initialize(struct sleep_save *ptr, int count)
{
       SAVE_ITEM_DUM(ptr, S3C_VIDCON0)
       SAVE_ITEM_DUM(ptr, S3C_VIDCON1);

       SAVE_ITEM_DUM(ptr, S3C_VIDTCON0);
       SAVE_ITEM_DUM(ptr, S3C_VIDTCON1);
       SAVE_ITEM_DUM(ptr, S3C_VIDTCON2);
       SAVE_ITEM_DUM(ptr, S3C_VIDTCON3);

       SAVE_ITEM_DUM(ptr, S3C_WINCON0);
       SAVE_ITEM_DUM(ptr, S3C_WINCON1);
       SAVE_ITEM_DUM(ptr, S3C_WINCON2);
       SAVE_ITEM_DUM(ptr, S3C_WINCON3);
       SAVE_ITEM_DUM(ptr, S3C_WINCON4);

       SAVE_ITEM_DUM(ptr, S3C_VIDOSD0A);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD0B);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD0C);

       SAVE_ITEM_DUM(ptr, S3C_VIDOSD1A);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD1B);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD1C);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD1D);

       SAVE_ITEM_DUM(ptr, S3C_VIDOSD2A);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD2B);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD2C);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD2D);

       SAVE_ITEM_DUM(ptr, S3C_VIDOSD3A);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD3B);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD3C);

       SAVE_ITEM_DUM(ptr, S3C_VIDOSD4A);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD4B);
       SAVE_ITEM_DUM(ptr, S3C_VIDOSD4C);

       SAVE_ITEM_DUM(ptr, S3C_VIDW00ADD0B0);
       SAVE_ITEM_DUM(ptr, S3C_VIDW00ADD0B1);
       SAVE_ITEM_DUM(ptr, S3C_VIDW01ADD0B0);
       SAVE_ITEM_DUM(ptr, S3C_VIDW01ADD0B1);
       SAVE_ITEM_DUM(ptr, S3C_VIDW02ADD0);
       SAVE_ITEM_DUM(ptr, S3C_VIDW03ADD0);
       SAVE_ITEM_DUM(ptr, S3C_VIDW04ADD0);
       SAVE_ITEM_DUM(ptr, S3C_VIDW00ADD1B0);
       SAVE_ITEM_DUM(ptr, S3C_VIDW00ADD1B1);
       SAVE_ITEM_DUM(ptr, S3C_VIDW01ADD1B0);
       SAVE_ITEM_DUM(ptr, S3C_VIDW01ADD1B1);
       SAVE_ITEM_DUM(ptr, S3C_VIDW02ADD1);
       SAVE_ITEM_DUM(ptr, S3C_VIDW03ADD1);
       SAVE_ITEM_DUM(ptr, S3C_VIDW04ADD1);
       SAVE_ITEM_DUM(ptr, S3C_VIDW00ADD2);
       SAVE_ITEM_DUM(ptr, S3C_VIDW01ADD2);
       SAVE_ITEM_DUM(ptr, S3C_VIDW02ADD2);
       SAVE_ITEM_DUM(ptr, S3C_VIDW03ADD2);
       SAVE_ITEM_DUM(ptr, S3C_VIDW04ADD2);

       SAVE_ITEM_DUM(ptr, S3C_VIDINTCON0);
       SAVE_ITEM_DUM(ptr, S3C_VIDINTCON1);
       SAVE_ITEM_DUM(ptr, S3C_W1KEYCON0);
       SAVE_ITEM_DUM(ptr, S3C_W1KEYCON1);
       SAVE_ITEM_DUM(ptr, S3C_W2KEYCON0);
       SAVE_ITEM_DUM(ptr, S3C_W2KEYCON1);

       SAVE_ITEM_DUM(ptr, S3C_W3KEYCON0);
       SAVE_ITEM_DUM(ptr, S3C_W3KEYCON1);
       SAVE_ITEM_DUM(ptr, S3C_W4KEYCON0);
       SAVE_ITEM_DUM(ptr, S3C_W4KEYCON1);
       SAVE_ITEM_DUM(ptr, S3C_DITHMODE);

       SAVE_ITEM_DUM(ptr, S3C_WIN0MAP);
       SAVE_ITEM_DUM(ptr, S3C_WIN1MAP);
       SAVE_ITEM_DUM(ptr, S3C_WIN2MAP);
       SAVE_ITEM_DUM(ptr, S3C_WIN3MAP);
       SAVE_ITEM_DUM(ptr, S3C_WIN4MAP);
       SAVE_ITEM_DUM(ptr, S3C_WPALCON);

       SAVE_ITEM_DUM(ptr, S3C_TRIGCON);
       SAVE_ITEM_DUM(ptr, S3C_I80IFCONA0);
       SAVE_ITEM_DUM(ptr, S3C_I80IFCONA1);
       SAVE_ITEM_DUM(ptr, S3C_I80IFCONB0);
       SAVE_ITEM_DUM(ptr, S3C_I80IFCONB1);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMDCON0);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMDCON1);
       SAVE_ITEM_DUM(ptr, S3C_SIFCCON0);
       SAVE_ITEM_DUM(ptr, S3C_SIFCCON1);
       SAVE_ITEM_DUM(ptr, S3C_SIFCCON2);

       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD0);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD1);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD2);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD3);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD4);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD5);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD6);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD7);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD8);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD9);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD10);
       SAVE_ITEM_DUM(ptr, S3C_LDI_CMD11);

       SAVE_ITEM_DUM(ptr, S3C_W2PDATA01);
       SAVE_ITEM_DUM(ptr, S3C_W2PDATA23);
       SAVE_ITEM_DUM(ptr, S3C_W2PDATA45);
       SAVE_ITEM_DUM(ptr, S3C_W2PDATA67);
       SAVE_ITEM_DUM(ptr, S3C_W2PDATA89);
       SAVE_ITEM_DUM(ptr, S3C_W2PDATAAB);
       SAVE_ITEM_DUM(ptr, S3C_W2PDATACD);
       SAVE_ITEM_DUM(ptr, S3C_W2PDATAEF);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATA01);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATA23);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATA45);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATA67);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATA89);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATAAB);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATACD);
       SAVE_ITEM_DUM(ptr, S3C_W3PDATAEF);
       SAVE_ITEM_DUM(ptr, S3C_W4PDATA01);
       SAVE_ITEM_DUM(ptr, S3C_W4PDATA23);

       //SAVE_ITEM_DUM(ptr, S3C_HOSTIFB_MIFPCON);
       /* for Idle Current GPIO Setting */
       SAVE_ITEM_DUM(ptr, S3C64XX_GPICON);
       SAVE_ITEM_DUM(ptr, S3C64XX_GPIDAT);
       SAVE_ITEM_DUM(ptr, S3C64XX_GPIPUD);
       SAVE_ITEM_DUM(ptr, S3C64XX_GPJCON);
       SAVE_ITEM_DUM(ptr, S3C64XX_GPJDAT);
       SAVE_ITEM_DUM(ptr, S3C64XX_GPJPUD);
}
...
static int s3cfb_suspend_sub(s3c_fb_info_t *fbi)
{
    ...
    s3c_pm_tmp_initialize(s3c_lcd_save, ARRAY_SIZE(s3c_lcd_save));
...
#ifdef USE_LCD_DOMAIN_GATING_DIS
        //s3c_set_normal_cfg(S3C64XX_DOMAIN_F, S3C64XX_ACTIVE_MODE, S3C64XX_LCD);
        s3c64xx_pd_ctrl(S3C64XX_NORMALCFG_DOMAIN_F_ON, )
