...
#include "s3cfb.h"
#include "s3cfb_old_reg-lcd.h"


//extern void standby_on(void);
//extern void standby_off(void); //TODO ALMAR FIX

extern void __iomem  *lcd_regs;

s3c_fimd_info_t s3c_fimd = {
// KSS_2009-09-03 : Change LCD Dot Clk
#ifndef S3C_FB_USE_CLK_DIRECTED
	.vidcon0 = VIDCON0 | VIDCON0_VIDOUT_RGB | VIDCON0_L1_DATA_16BPP | \
	           VIDCON0_L0_DATA_16BPP | VIDCON0_PNRMODE_RGB | \
	           0x00 /*VIDCON0_CLKVALUP_ALWAYS*/ | VIDCON0_CLKDIR | (((1)&0x3)<<2)/*S3C_VIDCON0_CLKSEL(1)*/ | \
	           0x00/*S3C_VIDCON0_ENVID_DISABLE*/ | 0x00/*S3C_VIDCON0_ENVID_F_DISABLE*/,
#else
	.vidcon0 = VIDCON0 | VIDCON0_VIDOUT_RGB | VIDCON0_L1_DATA_16BPP | \
	           VIDCON0_L0_DATA_16BPP | VIDCON0_PNRMODE_RGB | \
	           0x00 /*VIDCON0_CLKVALUP_ALWAYS*/ | S3C_VIDCON0_CLKDIR_DIRECTED | (((1)&0x3)<<2)/*S3C_VIDCON0_CLKSEL(1)*/ | \
	           0x00/*S3C_VIDCON0_ENVID_DISABLE*/ | 0x00/*S3C_VIDCON0_ENVID_F_DISABLE*/,
#endif
// End of KSS_2009-09-03
	.dithmode = (DITHMODE_R_POS_5BIT | DITHMODE_G_POS_6BIT | DITHMODE_B_POS_5BIT ) & 0x00/*S3C_DITHMODE_DITHERING_DISABLE*/,

#if defined (CONFIG_FB_S3C_BPP_8)
	.wincon0 =  WINCONx_BYTSWP | WINCONx_BURSTLEN_4WORD | WINCON0_BPPMODE_8BPP_PALETTE,
	.wincon1 =  WINCONx_HAWSWP | WINCONx_BURSTLEN_4WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL,
	.bpp = S3C_FB_PIXEL_BPP_8,
	.bytes_per_pixel = 1,
	.wpalcon = WPALCON_W0PAL_16BPP_565,

#elif defined (CONFIG_FB_S3C_BPP_16)
	.wincon0 = 0x00/*S3C_WINCONx_ENLOCAL_DMA*/ | 0x00/*S3C_WINCONx_BUFSEL_0*/ | 0x00/*S3C_WINCONx_BUFAUTOEN_DISABLE*/ | \
	           0x00/*S3C_WINCONx_BITSWP_DISABLE*/ | 0x00/*S3C_WINCONx_BYTSWP_DISABLE*/ | WINCONx_HAWSWP | \
	           WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_ENWIN_F_DISABLE*/,

	.wincon1 = 0x00/*S3C_WINCONx_ENLOCAL_DMA*/ | 0x00/*S3C_WINCONx_BUFSEL_0*/ | 0x00/*S3C_WINCONx_BUFAUTOEN_DISABLE*/ | \
	           0x00/*S3C_WINCONx_BITSWP_DISABLE*/ | 0x00/*S3C_WINCONx_BYTSWP_DISABLE*/ | WINCONx_HAWSWP | \
	           WINCONx_BURSTLEN_16WORD | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON0_BPPMODE_16BPP_565 | \
	           WINCON1_ALPHA_SEL | 0x00/*S3C_WINCONx_ENWIN_F_DISABLE*/,

	.wincon2 = 0x00/*S3C_WINCONx_ENLOCAL_DMA*/ | 0x00/*S3C_WINCONx_BITSWP_DISABLE*/ | 0x00/*S3C_WINCONx_BYTSWP_DISABLE*/ | \
	           WINCONx_HAWSWP | WINCONx_BURSTLEN_4WORD | WINCONx_BURSTLEN_16WORD | \
	           0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON0_BPPMODE_16BPP_565 | WINCON1_ALPHA_SEL | 0x00/*S3C_WINCONx_ENWIN_F_DISABLE*/,

	.wincon3 = 0x00/*S3C_WINCONx_BITSWP_DISABLE*/ | 0x00/*S3C_WINCONx_BYTSWP_DISABLE*/ | WINCONx_HAWSWP | \
	           WINCONx_BURSTLEN_4WORD | WINCONx_BURSTLEN_16WORD | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | \
	           WINCON0_BPPMODE_16BPP_565 | WINCON1_ALPHA_SEL | 0x00/*S3C_WINCONx_ENWIN_F_DISABLE*/,

	.wincon4 = 0x00/*S3C_WINCONx_BITSWP_DISABLE*/ | 0x00/*S3C_WINCONx_BYTSWP_DISABLE*/ | WINCONx_HAWSWP | \
	           WINCONx_BURSTLEN_4WORD | WINCONx_BURSTLEN_16WORD | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ |
	           WINCON0_BPPMODE_16BPP_565 | WINCON1_ALPHA_SEL | 0x00/*S3C_WINCONx_ENWIN_F_DISABLE*/,
	...
	.wincon0 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888,
	.wincon1 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL,
	.wincon2 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL,
	.wincon3 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL,
	.wincon4 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL,
	.bpp = S3C_FB_PIXEL_BPP_24,
	.bytes_per_pixel = 4,
	.wpalcon = S3C_WPALCON_W0PAL_24BIT,
#endif

	.vidosd1c = VIDISD14C_ALPHA1_B(VIDISD14C_ALPHA1_B_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_G(VIDISD14C_ALPHA1_G_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_R(VIDISD14C_ALPHA1_R_LIMIT&S3C_FB_MAX_ALPHA_LEVEL),
	.vidosd2c = VIDISD14C_ALPHA1_B(VIDISD14C_ALPHA1_B_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_G(VIDISD14C_ALPHA1_G_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_R(VIDISD14C_ALPHA1_R_LIMIT&S3C_FB_MAX_ALPHA_LEVEL),
	.vidosd3c = VIDISD14C_ALPHA1_B(VIDISD14C_ALPHA1_B_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_G(VIDISD14C_ALPHA1_G_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_R(VIDISD14C_ALPHA1_R_LIMIT&S3C_FB_MAX_ALPHA_LEVEL),
	.vidosd4c = VIDISD14C_ALPHA1_B(VIDISD14C_ALPHA1_B_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_G(VIDISD14C_ALPHA1_G_LIMIT&S3C_FB_MAX_ALPHA_LEVEL) | VIDISD14C_ALPHA1_R(VIDISD14C_ALPHA1_R_LIMIT&S3C_FB_MAX_ALPHA_LEVEL),

	.vidintcon0 = VIDINTCON0_FRAMESEL0_VSYNC | VIDINTCON0_FRAMESEL1_NONE | 0x00/*S3C_VIDINTCON0_INTFRMEN_DISABLE*/ | \
	              VIDINTCON0_FIFIOSEL_WINDOW0 | VIDINTCON0_FIFOLEVEL_TO25PC | 0x00/*S3C_VIDINTCON0_INTFIFOEN_DISABLE*/ | VIDINTCON0_INT_ENABLE,
	.vidintcon1 = 0,

	.xoffset = 0,
	.yoffset = 0,

	.w1keycon0 = 0x00/*S3C_WxKEYCON0_KEYBLEN_DISABLE*/ | 0x00/*S3C_WxKEYCON0_KEYEN_F_DISABLE*/ | 0x00/*S3C_WxKEYCON0_DIRCON_MATCH_FG_IMAGE*/ | WxKEYCON0_COMPKEY(WxKEYCON0_COMPKEY_LIMIT&0x0),
	.w1keycon1 = WxKEYCON1_COLVAL(WxKEYCON1_COLVAL_LIMIT&0xffffff),
	.w2keycon0 = 0x00/*S3C_WxKEYCON0_KEYBLEN_DISABLE*/ | 0x00/*S3C_WxKEYCON0_KEYEN_F_DISABLE*/ | 0x00/*S3C_WxKEYCON0_DIRCON_MATCH_FG_IMAGE*/ | WxKEYCON0_COMPKEY(WxKEYCON0_COMPKEY_LIMIT&0x0),
	.w2keycon1 = WxKEYCON1_COLVAL(WxKEYCON1_COLVAL_LIMIT&0xffffff),
	.w3keycon0 = 0x00/*S3C_WxKEYCON0_KEYBLEN_DISABLE*/ | 0x00/*S3C_WxKEYCON0_KEYEN_F_DISABLE*/ | 0x00/*S3C_WxKEYCON0_DIRCON_MATCH_FG_IMAGE*/ | WxKEYCON0_COMPKEY(WxKEYCON0_COMPKEY_LIMIT&0x0),
	.w3keycon1 = WxKEYCON1_COLVAL(WxKEYCON1_COLVAL_LIMIT&0xffffff),
	.w4keycon0 = 0x00/*S3C_WxKEYCON0_KEYBLEN_DISABLE*/ | 0x00/*S3C_WxKEYCON0_KEYEN_F_DISABLE*/ | 0x00/*S3C_WxKEYCON0_DIRCON_MATCH_FG_IMAGE*/ | WxKEYCON0_COMPKEY(WxKEYCON0_COMPKEY_LIMIT&0x0),
	.w4keycon1 = WxKEYCON1_COLVAL(WxKEYCON1_COLVAL_LIMIT&0xffffff),
...
#if  defined(CONFIG_SAMSUNG_DEV_PWM)
...
static void s3cfb_change_buff(int req_win, int req_fb)
{
	...
	case 0:
		if (req_fb == 0)
			s3c_fimd.wincon0 &= ~WINCONx_BUFSEL;
		else
			s3c_fimd.wincon0 |= WINCONx_BUFSEL;

		writel(s3c_fimd.wincon0 | WINCONx_ENWIN, S3C_WINCON0);
		break;

	case 1:
		if (req_fb == 0)
			s3c_fimd.wincon1 &= ~WINCONx_BUFSEL;
		else
			s3c_fimd.wincon1 |= WINCONx_BUFSEL;

		writel(s3c_fimd.wincon1 | WINCONx_ENWIN, S3C_WINCON1);
		break;
...
static int s3cfb_vs_start(s3c_fb_info_t *fbi)
{
	...
	{
		case 0 :
			s3c_fimd.wincon0 &= ~(WINCONx_ENWIN);
			writel(s3c_fimd.wincon0 | WINCONx_ENWIN, S3C_WINCON0);
			break;
		case 1 :
			s3c_fimd.wincon1 &= ~(WINCONx_ENWIN);
			writel(s3c_fimd.wincon1 | WINCONx_ENWIN, S3C_WINCON1);
			break;
		case 2 :
			s3c_fimd.wincon2 &= ~(WINCONx_ENWIN);
			writel(s3c_fimd.wincon2 | WINCONx_ENWIN, S3C_WINCON2);
			break;
		case 3 :
			s3c_fimd.wincon3 &= ~(WINCONx_ENWIN);
			writel(s3c_fimd.wincon3 | WINCONx_ENWIN, S3C_WINCON3);
			break;
		case 4 :
			s3c_fimd.wincon4 &= ~(WINCONx_ENWIN);
			writel(s3c_fimd.wincon4 | WINCONx_ENWIN, S3C_WINCON4);
			break;
		default : 
...
void s3cfb_write_palette(s3c_fb_info_t *fbi)
{
	...
	writel((s3c_fimd.wpalcon | WPALCON_PAL_UPDATE), S3C_WPALCON);
...
//	writel(readl(regs + VIDINTCON1), regs + VIDINTCON1);
...
void s3cfb_enable_local_post(int in_yuv)
{
	...
	s3c_fimd.wincon0 &= ~(WINCONx_ENLOCAL | WINCONx_YCbCr);
	value = WINCONx_ENLOCAL | WINCONx_ENWIN;
...
static void s3cfb_check_line_count(void)
{
	...
	if (i == timeout) {
		...
		cfg |= (VIDCON0_ENVID_F | VIDCON0_ENVID);
...
static void s3cfb_enable_local1(int in_yuv, int sel)
{
	...
	s3c_fimd.wincon1 &= ~(WINCONx_ENLOCAL | WINCONx_YCbCr);
	s3c_fimd.wincon1 &= ~(WINCON1_LOCALSEL_CAMIF);
	value = sel | WINCONx_ENLOCAL | WINCONx_ENWIN;
...
static void s3cfb_enable_local2(int in_yuv, int sel)
{
	...
	s3c_fimd.wincon2 &= ~WINCONx_ENWIN;
	s3c_fimd.wincon2 &= ~WINCON2_LOCALSEL_CAMIF;
	writel(s3c_fimd.wincon2, S3C_WINCON2);

	s3c_fimd.wincon2 &= ~(WINCONx_ENLOCAL | WINCONx_YCbCr);
	value = sel | WINCONx_ENLOCAL | WINCONx_ENWIN;
...
void s3cfb_enable_dma(void)
{
	...
	s3c_fimd.wincon0 &= ~(WINCONx_ENLOCAL | WINCONx_YCbCr);
	value = 0x00/*S3C_WINCONx_ENLOCAL_DMA*/ | WINCONx_ENWIN;
...
// KSS_2009-09-03 : Change LCD Dot Clk
#ifndef S3C_FB_USE_CLK_DIRECTED
		s3c_fimd.vidcon0 |= VIDCON0_CLKVAL_F(VIDCON0_CLKVAL_F_LIMIT&(int)(((((clk_get_rate(lcd_clock) * 10) / s3c_fimd.pixclock) % 10) > 4) ?
		...
		s3c_fimd.vidcon0 &= ~VIDCON0_CLKVAL_F(VIDCON0_CLKVAL_F_LIMIT&0xFF);
#endif	// End of S3C_FB_USE_CLK_DIRECTED

		s3c_fimd.vidcon0 = s3c_fimd.vidcon0 | (VIDCON0_ENVID | VIDCON0_ENVID_F);
...
void s3cfb_activate_var(s3c_fb_info_t *fbi, struct fb_var_screeninfo *var)
{
	...
	case 8:
		s3c_fimd.wincon0 = WINCONx_BYTSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_8BPP_PALETTE;
		s3c_fimd.wincon1 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon2 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon3 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon4 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.bpp     = S3C_FB_PIXEL_BPP_8;
		s3c_fimd.bytes_per_pixel = 1;
		s3c_fimd.wpalcon = WPALCON_W0PAL_16BPP_565;
		break;

	case 16:
		s3c_fimd.wincon0 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565;
		s3c_fimd.wincon1 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon2 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon3 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon4 = WINCONx_HAWSWP | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_16BPP_565 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
	...
	case 24:
		s3c_fimd.wincon0 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888;
		s3c_fimd.wincon1 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon2 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon3 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
		s3c_fimd.wincon4 = 0x00/*S3C_WINCONx_HAWSWP_DISABLE*/ | WINCONx_BURSTLEN_16WORD | WINCON0_BPPMODE_24BPP_888 | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL;
	...
	writel(s3c_fimd.wpalcon, S3C_WPALCON);
	writel(s3c_fimd.wincon0 | WINCONx_ENWIN, S3C_WINCON0);
	writel(s3c_fimd.vidcon0 | VIDCON0_ENVID | VIDCON0_ENVID_F, S3C_VIDCON0);
}
...
static int s3cfb_set_alpha_level(s3c_fb_info_t *fbi, unsigned int level, unsigned int alpha_index)
{
	...
	if (alpha_index == 0) {
		alpha_val &= ~(VIDISD14C_ALPHA0_B(0xF&0xf) | VIDISD14C_ALPHA0_G(0xF&0xf) | VIDISD14C_ALPHA0_R(0xF&0xf));
		alpha_val |= VIDISD14C_ALPHA0_B(0xF&level) | VIDISD14C_ALPHA0_G(0xF&level) | VIDISD14C_ALPHA0_R(0xF&level);
	} else {
		alpha_val &= ~(VIDISD14C_ALPHA1_B(VIDISD14C_ALPHA1_B_LIMIT&0xf) | VIDISD14C_ALPHA1_G(VIDISD14C_ALPHA1_G_LIMIT&0xf) | VIDISD14C_ALPHA1_R(VIDISD14C_ALPHA1_R_LIMIT&0xf));
		alpha_val = VIDISD14C_ALPHA1_B(VIDISD14C_ALPHA1_B_LIMIT&level) | VIDISD14C_ALPHA1_G(VIDISD14C_ALPHA1_G_LIMIT&level) | VIDISD14C_ALPHA1_R(VIDISD14C_ALPHA1_R_LIMIT&level);
	}
...
int s3cfb_set_alpha_mode(s3c_fb_info_t *fbi, int mode)
{
	...
	alpha_mode &= ~(WINCON1_BLD_PIX | WINCON1_ALPHA_SEL);

	switch (mode) {
	case S3CFB_ALPHA_MODE_PLANE: /* Plane Blending */
		writel(alpha_mode | 0x00/*S3C_WINCONx_BLD_PIX_PLANE*/ | WINCON1_ALPHA_SEL, S3C_WINCON0 + (0x04 * win_num));
		break;

	case S3CFB_ALPHA_MODE_PIXEL: /* Pixel Blending & chroma(color) key */
		writel(alpha_mode | WINCON1_BLD_PIX | 0x00/*S3C_WINCONx_ALPHA_SEL_0*/, S3C_WINCON0 + (0x04 * win_num));
		break;
	}
...
{
	if (on)
		writel(VIDCON2_ORGYCbCr | VIDCON2_YUVORDCrCb, S3C_VIDCON2);
	else
...
int s3cfb_ioctl(struct fb_info *info, unsigned int cmd, unsigned long arg)
{
	...
	case S3C_FB_SET_VSYNC_INT:
		s3c_fimd.vidintcon0 &= ~VIDINTCON0_FRAMESEL0_MASK;
		s3c_fimd.vidintcon0 |= VIDINTCON0_FRAMESEL0_VSYNC;

		if (arg)
			s3c_fimd.vidintcon0 |= VIDINTCON0_INT_FRAME;
		else
			s3c_fimd.vidintcon0 &= ~VIDINTCON0_INT_FRAME;
...
//#endif
	...
	writel(0x0, S3C64XX_MODEM_MIFPCON);
