...
static struct s3c_pin_cfg_entry spica_slp_config[] __initdata = {
	...
	/* Bit banged I2C */
//	S3C_PIN(GPIO_USBSW_SCL_3V0), 	S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE), //no SLP in original mach-jet.c 
//	S3C_PIN(GPIO_USBSW_SDA_3V0), 	S3C64XX_PIN_SLP(IN), S3C_PIN_PULL(NONE), //no SLP in original mach-jet.c 
