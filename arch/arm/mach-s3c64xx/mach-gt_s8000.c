...
#define GPIO_TFLASH_EN		S3C64XX_GPG(6)	//J
#define GPIO_CAM_EN		S3C64XX_GPK(1)	//J
#define GPIO_EARPATH_SEL	S3C64XX_GPK(2)	//J
#define GPIO_EAR_CP_CODEC_SW	S3C64XX_GPK(3)	//J
#define GPIO_MAIN_CP_CODEC_SW	S3C64XX_GPK(4)	//J
#define GPIO_FM_RST		S3C64XX_GPK(5)	//J
#define GPIO_CAM_VGA_RST_N	S3C64XX_GPK(12)	//J
#define GPIO_CAM_VGA_STBY_N	S3C64XX_GPK(13)	//J
#define GPIO_MSENSE_RST		S3C64XX_GPK(14)	//J
#define GPIO_USIM_BOOT		S3C64XX_GPK(15)	//J
#define GPIO_5M_EN		S3C64XX_GPL(3)	//J// SPICA name: CAM_3M_STBY_N
#define GPIO_VIB_EN		S3C64XX_GPL(4)	//J// Jet name: VIBTONE_EN
#define GPIO_USB_SEL		S3C64XX_GPL(5)	//J
#define GPIO_TV_EN		S3C64XX_GPL(6)	//J
#define GPIO_TOUCH_EN		S3C64XX_GPL(7)	//J
#define GPIO_EXTWKUP		S3C64XX_GPL(11)	//J
#define GPIO_BT_WAKE		S3C64XX_GPM(4)	//J
#define GPIO_ALPS_ON		S3C64XX_GPM(5)	//J
#define GPIO_MAX8906_AMP_EN	S3C64XX_GPN(1)	//J
#define GPIO_PDA_ACTIVE		S3C64XX_GPN(3)	//J
#define GPIO_FM_LDO_ON		S3C64XX_GPN(4)	//J
#define GPIO_PHONE_ON		S3C64XX_GPN(6)	//J
#define GPIO_CP_BOOT_SEL	S3C64XX_GPO(2)	//J
#define GPIO_PCM_SEL		S3C64XX_GPO(5)	//J
#define GPIO_LCD_CS_N		S3C64XX_GPO(6)	//J
#define GPIO_LCD_SDI		S3C64XX_GPO(7)	//J
#define GPIO_LCD_RST_N		S3C64XX_GPO(10)	//J
#define GPIO_LCD_SCLK		S3C64XX_GPO(12)	//J
#define GPIO_PDA_PS_HOLD	S3C64XX_GPP(13)	//J
#define GPIO_UART_SEL		S3C64XX_GPQ(2)	//J
#define GPIO_VT_CP_SW		S3C64XX_GPQ(4)	//J
...
#define GPIO_TF_DETECT		S3C64XX_GPL(8)	//J// Jet name: T_FLASH_DETECT
...
#define GPIO_POWER_N		S3C64XX_GPN(5)	//J
#define GPIO_PHONE_ACTIVE	S3C64XX_GPN(7)	//J
#define GPIO_PMIC_INT_N		S3C64XX_GPN(8)	//J
#define GPIO_EAR_SEND_END	S3C64XX_GPN(11)	//J
#define GPIO_JACK_INT_N		S3C64XX_GPN(12)	//J
#define GPIO_BOOT_EINT13	S3C64XX_GPN(13)	//J
#define GPIO_BOOT_EINT14	S3C64XX_GPN(14)	//J
#define GPIO_BOOT_EINT15	S3C64XX_GPN(15)	//J
#define GPIO_RESOUT_N		S3C64XX_GPO(3)	//J
...
static struct s3c_pin_cfg_entry spica_slp_config[] __initdata = {
	...
	S3C_PIN(GPIO_CAM_EN),		S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	...
	S3C_PIN(GPIO_USIM_BOOT), 	S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	...
	S3C_PIN(GPIO_PDA_ACTIVE), 	S3C64XX_PIN_SLP(RETAIN), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_FM_LDO_ON), 	S3C64XX_PIN_SLP(LOW), S3C_PIN_PULL(NONE),
	S3C_PIN(GPIO_PHONE_ON), 	S3C64XX_PIN_SLP(RETAIN), S3C_PIN_PULL(NONE),
